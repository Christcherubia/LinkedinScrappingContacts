...
;
        // Recherche réseau
        await page.click('[.global-nav__primary-link ember-view]', {delay: 180});
        await page.click('[.display-flex.mt2 button]', {delay: 189}); 
        

        // Entrer ceci dans la console dev tools :
        Linkedin = {
            config: {
            scrollDelay: 3000,
            actionDelay: 5000,
            ...
            addNote: true,
            note: "Bonjour à vous, je suis Christopher, programmeur web, hacker éthique junior et data scraper, j'aimerais agrandir mon réseau."
            },
            ...
            let names = document.getElementsByClassName("entity-result__title-text");
           ...
           data.pageButtonTotal);
            let button = data.pageButtons[data.pageButtonIndex];
            button.click();
            ...
            let addNoteButton = Array.prototype.filter.call(buttons, function (el) {
           ...
           data.connectNames[data.pageButtonIndex]);
            ...
            let buttons = document.querySelectorAll('button');
            let doneButton = Array.prototype.filter.call(buttons, function (el) {
           ...
           config.actionDelay);
            ...
            let closeButton = document.getElementsByClassName('artdeco-modal__dismiss artdeco-button artdeco-button--circle artdeco-button--muted artdeco-button--2 artdeco-button--tertiary emberview');
           ...
           config.actionDelay + " ms");
            ...
            let pagerButton = document.getElementsByClassName('artdeco-pagination__button--next');
            ...
            totalRows: function () {
            let search_results = document.getElementsByClassName('search-result');
